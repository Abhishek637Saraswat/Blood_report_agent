...
from tools import search_tool, ReadBloodTestPDFTool,NutritionListTool,ExerciseListTool
...
doctor=Agent(
    ...
    tools=[ReadBloodTestPDFTool(),NutritionListTool(),ExerciseListTool(),search_tool],
    llm=llm,
    max_iter=10,
    max_rpm=10,
